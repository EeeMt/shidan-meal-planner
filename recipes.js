 ...
 *   isMeat     荤素标注（boolean）：荤=占荤位（含肉/禽/水产/加工肉）；素=蛋/豆腐/菌菇/蔬菜等无肉
...
(function (root, factory) {
  ...
  return [
    // ============ 蛋豆 ============
    {
      id: 'xihongshi-chaojidan', name: '西红柿炒鸡蛋', emoji: '🍅', category: '蛋豆', isMeat: false, difficulty: 1, minutes: 15, servings: 2,
      tags: ['快手', '下饭'],
      ingredients: [
    ...
    {
      id: 'jiucai-chaojidan', name: '韭菜炒蛋', emoji: '🥬', category: '蛋豆', isMeat: false, difficulty: 1, minutes: 15, servings: 2,
      tags: ['快手'],
      ingredients: [
    ...
    {
      id: 'xiaren-chaojidan', name: '虾仁炒蛋', emoji: '🍤', category: '蛋豆', isMeat: true, difficulty: 1, minutes: 15, servings: 2,
      tags: ['快手', '高蛋白'],
      ingredients: [
    ...
    {
      id: 'mapo-doufu', name: '麻婆豆腐', emoji: '🌶️', category: '蛋豆', isMeat: true, difficulty: 2, minutes: 20, servings: 2,
      tags: ['下饭', '微辣'],
      ingredients: [
    ...
    {
      id: 'jiachang-doufu', name: '家常豆腐', emoji: '🍢', category: '蛋豆', isMeat: false, difficulty: 2, minutes: 25, servings: 2,
      tags: ['下饭'],
      ingredients: [
    ...
    {
      id: 'xiangjian-doufu', name: '香煎豆腐', emoji: '🟨', category: '蛋豆', isMeat: false, difficulty: 1, minutes: 20, servings: 2,
      tags: ['快手'],
      ingredients: [
    ...
    {
      id: 'roumo-zhengdan', name: '肉末蒸蛋', emoji: '🥚', category: '蛋豆', isMeat: true, difficulty: 1, minutes: 20, servings: 2,
      tags: ['快手', '高蛋白'],
      ingredients: [
    ...
    {
      id: 'pidan-doufu', name: '皮蛋豆腐', emoji: '🥢', category: '凉菜', isMeat: false, difficulty: 1, minutes: 10, servings: 2,
      tags: ['快手', '凉菜'],
      ingredients: [
    ...
    {
      id: 'huanggua-chaojidan', name: '黄瓜炒鸡蛋', emoji: '🥒', category: '蛋豆', isMeat: false, difficulty: 1, minutes: 10, servings: 2,
      tags: ['快手', '清淡'],
      ingredients: [
    ...
    {
      id: 'hongshao-doufu', name: '红烧豆腐', emoji: '🍲', category: '蛋豆', isMeat: false, difficulty: 1, minutes: 20, servings: 2,
      tags: ['下饭', '微辣'],
      ingredients: [
    ...
    // ============ 荤菜 ============
    {
      id: 'qingjiao-rousi', name: '青椒肉丝', emoji: '🥩', category: '荤菜', isMeat: true, difficulty: 1, minutes: 20, servings: 2,
      tags: ['快手', '下饭'],
      ingredients: [
    ...
    {
      id: 'yuxiang-rousi', name: '鱼香肉丝', emoji: '🌶️', category: '荤菜', isMeat: true, difficulty: 2, minutes: 30, servings: 2,
      tags: ['下饭', '微辣'],
      ingredients: [
    ...
    {
      id: 'huiguo-rou', name: '回锅肉', emoji: '🥓', category: '荤菜', isMeat: true, difficulty: 2, minutes: 35, servings: 2,
      tags: ['下饭'],
      ingredients: [
    ...
    {
      id: 'hongshao-rou', name: '红烧肉', emoji: '🍖', category: '荤菜', isMeat: true, difficulty: 2, minutes: 90, servings: 3,
      tags: ['宴客', '硬菜'],
      ingredients: [
    ...
    {
      id: 'tudou-dunniurou', name: '土豆炖牛肉', emoji: '🥘', category: '荤菜', isMeat: true, difficulty: 2, minutes: 80, servings: 3,
      tags: ['硬菜', '下饭'],
      ingredients: [
    ...
    {
      id: 'kele-jichi', name: '可乐鸡翅', emoji: '🍗', category: '荤菜', isMeat: true, difficulty: 1, minutes: 30, servings: 2,
      tags: ['快手', '甜口'],
      ingredients: [
    ...
    {
      id: 'gongbao-jiding', name: '宫保鸡丁', emoji: '🥜', category: '荤菜', isMeat: true, difficulty: 2, minutes: 30, servings: 2,
      tags: ['下饭', '微辣'],
      ingredients: [
    ...
    {
      id: 'lazi-ji', name: '辣子鸡', emoji: '🌶️', category: '荤菜', isMeat: true, difficulty: 2, minutes: 35, servings: 2,
      tags: ['辣', '下饭'],
      ingredients: [
    ...
    {
      id: 'tangcu-paigu', name: '糖醋排骨', emoji: '🍖', category: '荤菜', isMeat: true, difficulty: 2, minutes: 60, servings: 3,
      tags: ['宴客', '甜口'],
      ingredients: [
    ...
    {
      id: 'suantai-chaorou', name: '蒜苔炒肉', emoji: '🥢', category: '荤菜', isMeat: true, difficulty: 1, minutes: 20, servings: 2,
      tags: ['快手', '下饭'],
      ingredients: [
    ...
    {
      id: 'qincai-chaoniurou', name: '芹菜炒牛肉', emoji: '🥬', category: '荤菜', isMeat: true, difficulty: 2, minutes: 20, servings: 2,
      tags: ['快手'],
      ingredients: [
    ...
    {
      id: 'yangcong-chaorousi', name: '洋葱炒肉丝', emoji: '🧅', category: '荤菜', isMeat: true, difficulty: 1, minutes: 20, servings: 2,
      tags: ['快手'],
      ingredients: [
    ...
    {
      id: 'muxu-rou', name: '木须肉', emoji: '🥒', category: '荤菜', isMeat: true, difficulty: 2, minutes: 25, servings: 2,
      tags: ['快手'],
      ingredients: [
    ...
    {
      id: 'xiaochao-huangniurou', name: '小炒黄牛肉', emoji: '🐂', category: '荤菜', isMeat: true, difficulty: 2, minutes: 25, servings: 2,
      tags: ['快手', '微辣'],
      ingredients: [
    ...
    {
      id: 'xianggu-huaji', name: '香菇滑鸡', emoji: '🍄', category: '荤菜', isMeat: true, difficulty: 1, minutes: 30, servings: 2,
      tags: ['下饭'],
      ingredients: [
    ...
    {
      id: 'hongshao-jitui', name: '红烧鸡腿', emoji: '🍗', category: '荤菜', isMeat: true, difficulty: 1, minutes: 40, servings: 2,
      tags: ['下饭'],
      ingredients: [
    ...
    {
      id: 'jingjiang-rousi', name: '京酱肉丝', emoji: '🥓', category: '荤菜', isMeat: true, difficulty: 2, minutes: 25, servings: 2,
      tags: ['下饭'],
      ingredients: [
    ...
    {
      id: 'ziran-yangrou', name: '孜然羊肉', emoji: '🐑', category: '荤菜', isMeat: true, difficulty: 2, minutes: 25, servings: 2,
      tags: ['孜然', '快手'],
      ingredients: [
    ...
    {
      id: 'heijiao-niuliu', name: '黑椒牛柳', emoji: '🐂', category: '荤菜', isMeat: true, difficulty: 2, minutes: 25, servings: 2,
      tags: ['快手'],
      ingredients: [
    ...
    {
      id: 'zhurou-dun-fentiao', name: '猪肉炖粉条', emoji: '🍲', category: '荤菜', isMeat: true, difficulty: 2, minutes: 50, servings: 3,
      tags: ['硬菜', '下饭'],
      ingredients: [
    ...
    {
      id: 'suandoujiao-chaoroumo', name: '酸豆角炒肉末', emoji: '🌶️', category: '荤菜', isMeat: true, difficulty: 1, minutes: 20, servings: 2,
      tags: ['快手', '下饭'],
      ingredients: [
    ...
    {
      id: 'roumo-qiezi', name: '肉末茄子', emoji: '🍆', category: '荤菜', isMeat: true, difficulty: 2, minutes: 25, servings: 2,
      tags: ['下饭'],
      ingredients: [
    ...
    {
      id: 'shuizhu-roupian', name: '水煮肉片', emoji: '🥩', category: '荤菜', isMeat: true, difficulty: 2, minutes: 30, servings: 2,
      tags: ['下饭', '微辣'],
      ingredients: [
    ...
    {
      id: 'tudou-rousi', name: '土豆肉丝', emoji: '🥔', category: '荤菜', isMeat: true, difficulty: 1, minutes: 20, servings: 2,
      tags: ['快手', '下饭', '微辣'],
      ingredients: [
    ...
    {
      id: 'huanggua-roupian', name: '黄瓜肉片', emoji: '🥒', category: '荤菜', isMeat: true, difficulty: 1, minutes: 15, servings: 2,
      tags: ['快手', '清淡', '微辣'],
      ingredients: [
    ...
    {
      id: 'xingbaogu-wuhuarou', name: '杏鲍菇五花肉', emoji: '🍄', category: '荤菜', isMeat: true, difficulty: 2, minutes: 25, servings: 2,
      tags: ['下饭', '微辣'],
      ingredients: [
    ...
    {
      id: 'huluobo-wuhuarou', name: '胡萝卜五花肉', emoji: '🥕', category: '荤菜', isMeat: true, difficulty: 1, minutes: 25, servings: 2,
      tags: ['下饭', '微辣'],
      ingredients: [
    ...
    {
      id: 'yuxiang-qiezi', name: '鱼香茄子', emoji: '🍆', category: '荤菜', isMeat: true, difficulty: 2, minutes: 30, servings: 2,
      tags: ['下饭', '微辣'],
      ingredients: [
    ...
    {
      id: 'hongshao-paigu', name: '红烧排骨', emoji: '🍖', category: '荤菜', isMeat: true, difficulty: 2, minutes: 55, servings: 3,
      tags: ['下饭', '硬菜'],
      ingredients: [
        { name: '排骨', amount: '500g' }, { name: '冰糖', amount: '20g' },
    ...
    {
      id: 'lajiao-chaorou', name: '辣椒炒肉', emoji: '🌶️', category: '荤菜', isMeat: true, difficulty: 1, minutes: 20, servings: 2,
      tags: ['下饭', '辣'],
      ingredients: [
    ...
    {
      id: 'mayi-shangshu', name: '蚂蚁上树', emoji: '🐜', category: '荤菜', isMeat: true, difficulty: 1, minutes: 20, servings: 2,
      tags: ['快手', '下饭', '微辣'],
      ingredients: [
    ...
    {
      id: 'xianggan-chaorou', name: '香干炒肉', emoji: '🍢', category: '荤菜', isMeat: true, difficulty: 1, minutes: 20, servings: 2,
      tags: ['快手', '下饭'],
      ingredients: [
    ...
    {
      id: 'huacai-chaorou', name: '花菜炒肉片', emoji: '🥦', category: '荤菜', isMeat: true, difficulty: 1, minutes: 20, servings: 2,
      tags: ['快手', '下饭'],
      ingredients: [
    ...
    {
      id: 'fenzheng-rou', name: '粉蒸肉', emoji: '🥩', category: '荤菜', isMeat: true, difficulty: 2, minutes: 50, servings: 3,
      tags: ['下饭', '微辣'],
      ingredients: [
    ...
    {
      id: 'larou-chaosuanmiao', name: '腊肉炒蒜苗', emoji: '🥓', category: '荤菜', isMeat: true, difficulty: 1, minutes: 25, servings: 2,
      tags: ['快手', '下饭'],
      ingredients: [
    ...
    {
      id: 'huluobo-tudou-shaopaigu', name: '胡萝卜土豆烧排骨', emoji: '🥘', category: '荤菜', isMeat: true, difficulty: 2, minutes: 70, servings: 3,
      tags: ['下饭', '硬菜'],
      ingredients: [
    ...
    {
      id: 'sijidou-shaopaigu', name: '四季豆烧排骨', emoji: '🫛', category: '荤菜', isMeat: true, difficulty: 2, minutes: 70, servings: 3,
      tags: ['下饭', '硬菜', '微辣'],
      ingredients: [
    ...
    {
      id: 'ganguo-paigu', name: '干锅排骨', emoji: '🌶️', category: '荤菜', isMeat: true, difficulty: 2, minutes: 45, servings: 3,
      tags: ['下饭', '辣'],
      ingredients: [
    ...
    {
      id: 'hongjiao-rousi', name: '红椒肉丝', emoji: '🫑', category: '荤菜', isMeat: true, difficulty: 1, minutes: 20, servings: 2,
      tags: ['快手', '下饭'],
      ingredients: [
    ...
    {
      id: 'shuangjiao-jiding', name: '双椒鸡丁', emoji: '🌶️', category: '荤菜', isMeat: true, difficulty: 1, minutes: 25, servings: 2,
      tags: ['下饭', '微辣'],
      ingredients: [
    ...
    {
      id: 'kugua-wuhuarou', name: '苦瓜五花肉', emoji: '🥒', category: '荤菜', isMeat: true, difficulty: 1, minutes: 25, servings: 2,
      tags: ['下饭'],
      ingredients: [
    ...
    {
      id: 'tudou-huiguorou', name: '土豆回锅肉', emoji: '🥔', category: '荤菜', isMeat: true, difficulty: 2, minutes: 35, servings: 2,
      tags: ['下饭', '微辣'],
      ingredients: [
    ...
    {
      id: 'qincai-douganrousi', name: '芹菜豆干肉丝', emoji: '🥬', category: '荤菜', isMeat: true, difficulty: 1, minutes: 20, servings: 2,
      tags: ['快手', '下饭'],
      ingredients: [
    ...
    {
      id: 'wosun-wuhuarou', name: '莴笋五花肉', emoji: '🥬', category: '荤菜', isMeat: true, difficulty: 1, minutes: 20, servings: 2,
      tags: ['快手', '下饭'],
      ingredients: [
    ...
    {
      id: 'moyu-shaoya', name: '魔芋烧鸭', emoji: '🦆', category: '荤菜', isMeat: true, difficulty: 2, minutes: 55, servings: 3,
      tags: ['下饭', '微辣'],
      ingredients: [
    ...
    {
      id: 'jiangdou-roumo', name: '豇豆肉末', emoji: '🫛', category: '荤菜', isMeat: true, difficulty: 1, minutes: 20, servings: 2,
      tags: ['快手', '下饭', '微辣'],
      ingredients: [
    ...
    {
      id: 'huluobo-niurousi', name: '胡萝卜牛肉丝', emoji: '🥕', category: '荤菜', isMeat: true, difficulty: 1, minutes: 25, servings: 2,
      tags: ['快手', '下饭'],
      ingredients: [
    ...
    {
      id: 'qingdou-roumo', name: '青豆肉沫', emoji: '🫛', category: '荤菜', isMeat: true, difficulty: 1, minutes: 20, servings: 2,
      tags: ['快手', '下饭', '微辣'],
      ingredients: [
    ...
    {
      id: 'suantai-larou', name: '蒜苔炒腊肉', emoji: '🥢', category: '荤菜', isMeat: true, difficulty: 1, minutes: 25, servings: 2,
      tags: ['快手', '下饭'],
      ingredients: [
    ...
    {
      id: 'baocai-larou', name: '包菜炒腊肉', emoji: '🥬', category: '荤菜', isMeat: true, difficulty: 1, minutes: 25, servings: 2,
      tags: ['快手', '下饭'],
      ingredients: [
    ...
    {
      id: 'hongsanduo', name: '红三剁', emoji: '🍅', category: '荤菜', isMeat: true, difficulty: 1, minutes: 20, servings: 2,
      tags: ['下饭', '微辣'],
      ingredients: [
    ...
    // ============ 水产 ============
    {
      id: 'qingzheng-luyu', name: '清蒸鲈鱼', emoji: '🐟', category: '水产', isMeat: true, difficulty: 2, minutes: 25, servings: 2,
      tags: ['宴客', '清淡'],
      ingredients: [
    ...
    {
      id: 'hongshao-yukuai', name: '红烧鱼块', emoji: '🐠', category: '水产', isMeat: true, difficulty: 2, minutes: 30, servings: 2,
      tags: ['下饭'],
      ingredients: [
    ...
    {
      id: 'xiangjian-daoyu', name: '香煎带鱼', emoji: '🐟', category: '水产', isMeat: true, difficulty: 1, minutes: 25, servings: 2,
      tags: ['快手'],
      ingredients: [
    ...
    {
      id: 'youmen-daxia', name: '油焖大虾', emoji: '🦐', category: '水产', isMeat: true, difficulty: 2, minutes: 25, servings: 2,
      tags: ['宴客'],
      ingredients: [
    ...
    {
      id: 'suanrong-fensixia', name: '蒜蓉粉丝虾', emoji: '🦐', category: '水产', isMeat: true, difficulty: 2, minutes: 30, servings: 2,
      tags: ['宴客'],
      ingredients: [
    ...
    {
      id: 'duojiao-yutou', name: '剁椒鱼头', emoji: '🌶️', category: '水产', isMeat: true, difficulty: 2, minutes: 35, servings: 2,
      tags: ['宴客', '辣'],
      ingredients: [
    ...
    {
      id: 'suancai-yu', name: '酸菜鱼', emoji: '🐟', category: '水产', isMeat: true, difficulty: 3, minutes: 45, servings: 3,
      tags: ['辣', '硬菜'],
      ingredients: [
    ...
    {
      id: 'baizhuo-xia', name: '白灼虾', emoji: '🦐', category: '水产', isMeat: true, difficulty: 1, minutes: 15, servings: 2,
      tags: ['快手', '高蛋白'],
      ingredients: [
    ...
    // ============ 素菜 ============
    {
      id: 'qinchao-shishu', name: '清炒时蔬', emoji: '🥬', category: '素菜', isMeat: false, difficulty: 1, minutes: 10, servings: 2,
      tags: ['快手', '清淡'],
      ingredients: [
    ...
    {
      id: 'suanrong-xilanhua', name: '蒜蓉西兰花', emoji: '🥦', category: '素菜', isMeat: false, difficulty: 1, minutes: 12, servings: 2,
      tags: ['快手', '清淡'],
      ingredients: [
    ...
    {
      id: 'shousi-baocai', name: '手撕包菜', emoji: '🥬', category: '素菜', isMeat: false, difficulty: 1, minutes: 15, servings: 2,
      tags: ['快手'],
      ingredients: [
    ...
    {
      id: 'culiu-tudousi', name: '醋溜土豆丝', emoji: '🥔', category: '素菜', isMeat: false, difficulty: 1, minutes: 15, servings: 2,
      tags: ['快手'],
      ingredients: [
    ...
    {
      id: 'disanxian', name: '地三鲜', emoji: '🍆', category: '素菜', isMeat: false, difficulty: 2, minutes: 30, servings: 2,
      tags: ['下饭'],
      ingredients: [
    ...
    {
      id: 'ganbian-sijidou', name: '干煸四季豆', emoji: '🫛', category: '素菜', isMeat: false, difficulty: 2, minutes: 25, servings: 2,
      tags: ['下饭'],
      ingredients: [
    ...
    {
      id: 'haoyou-shengcai', name: '蚝油生菜', emoji: '🥬', category: '素菜', isMeat: false, difficulty: 1, minutes: 10, servings: 2,
      tags: ['快手'],
      ingredients: [
    ...
    {
      id: 'suanrong-youmaicai', name: '蒜蓉油麦菜', emoji: '🥬', category: '素菜', isMeat: false, difficulty: 1, minutes: 10, servings: 2,
      tags: ['快手'],
      ingredients: [
    ...
    {
      id: 'baizhuo-caixin', name: '白灼菜心', emoji: '🥬', category: '素菜', isMeat: false, difficulty: 1, minutes: 10, servings: 2,
      tags: ['快手', '清淡'],
      ingredients: [
    ...
    {
      id: 'liangban-huanggua', name: '凉拌黄瓜', emoji: '🥒', category: '凉菜', isMeat: false, difficulty: 1, minutes: 10, servings: 2,
      tags: ['快手', '凉菜'],
      ingredients: [
    ...
    {
      id: 'liangban-muer', name: '凉拌木耳', emoji: '🍄', category: '凉菜', isMeat: false, difficulty: 1, minutes: 15, servings: 2,
      tags: ['快手', '凉菜'],
      ingredients: [
    ...
    {
      id: 'liangban-haidaisi', name: '凉拌海带丝', emoji: '🌊', category: '凉菜', isMeat: false, difficulty: 1, minutes: 15, servings: 2,
      tags: ['快手', '凉菜'],
      ingredients: [
    ...
    {
      id: 'shangtang-wawacai', name: '上汤娃娃菜', emoji: '🥬', category: '素菜', isMeat: false, difficulty: 2, minutes: 20, servings: 2,
      tags: ['清淡'],
      ingredients: [
    ...
    {
      id: 'suanla-baicai', name: '酸辣白菜', emoji: '🥬', category: '素菜', isMeat: false, difficulty: 1, minutes: 15, servings: 2,
      tags: ['快手', '微辣'],
      ingredients: [
    ...
    {
      id: 'xianggu-youcai', name: '香菇油菜', emoji: '🍄', category: '素菜', isMeat: false, difficulty: 1, minutes: 15, servings: 2,
      tags: ['快手'],
      ingredients: [
    ...
    {
      id: 'su-dongguapian', name: '素冬瓜片', emoji: '🥬', category: '素菜', isMeat: false, difficulty: 1, minutes: 15, servings: 2,
      tags: ['快手', '清淡'],
      ingredients: [
    ...
    {
      id: 'shaojiao-qiezi', name: '烧椒茄子', emoji: '🍆', category: '凉菜', isMeat: false, difficulty: 1, minutes: 20, servings: 2,
      tags: ['快手', '凉菜', '微辣', '下饭'],
      ingredients: [
    ...
    {
      id: 'hupi-qingjiao', name: '虎皮青椒', emoji: '🫑', category: '素菜', isMeat: false, difficulty: 1, minutes: 15, servings: 2,
      tags: ['快手', '下饭', '微辣'],
      ingredients: [
    ...
    {
      id: 'qiangchao-lianbai', name: '炝炒莲白', emoji: '🥬', category: '素菜', isMeat: false, difficulty: 1, minutes: 10, servings: 2,
      tags: ['快手', '微辣'],
      ingredients: [
        { name: '包菜', amount: '400g' }, { name: '干辣椒', amount: '3个' },
    ...
    {
      id: 'suanla-ouding', name: '酸辣藕丁', emoji: '🪷', category: '素菜', isMeat: false, difficulty: 1, minutes: 15, servings: 2,
      tags: ['快手', '下饭', '微辣'],
      ingredients: [
    ...
    {
      id: 'ganguo-huacai', name: '干锅花菜', emoji: '🥘', category: '素菜', isMeat: false, difficulty: 2, minutes: 25, servings: 2,
      tags: ['下饭', '微辣'],
      ingredients: [
    ...
    {
      id: 'hetang-xiaochao', name: '荷塘小炒', emoji: '🪷', category: '素菜', isMeat: false, difficulty: 1, minutes: 20, servings: 2,
      tags: ['快手', '清淡'],
      ingredients: [
    ...
    {
      id: 'suanrong-bocai', name: '蒜蓉菠菜', emoji: '🥬', category: '素菜', isMeat: false, difficulty: 1, minutes: 10, servings: 2,
      tags: ['快手', '清淡'],
      ingredients: [
    ...
    {
      id: 'suchao-sigua', name: '素炒丝瓜', emoji: '🥒', category: '素菜', isMeat: false, difficulty: 1, minutes: 10, servings: 2,
      tags: ['快手', '清淡'],
      ingredients: [
    ...
    {
      id: 'jiangdou-qiezi', name: '豇豆茄子', emoji: '🍆', category: '素菜', isMeat: false, difficulty: 2, minutes: 25, servings: 2,
      tags: ['下饭', '微辣'],
      ingredients: [
    ...
    {
      id: 'chao-xiaobaicai', name: '炒小白菜', emoji: '🥬', category: '素菜', isMeat: false, difficulty: 1, minutes: 10, servings: 2,
      tags: ['快手', '清淡'],
      ingredients: [
    ...
    {
      id: 'tangcu-lianbai', name: '糖醋莲白', emoji: '🥬', category: '素菜', isMeat: false, difficulty: 1, minutes: 15, servings: 2,
      tags: ['快手', '下饭', '微辣'],
      ingredients: [
    ...
    {
      id: 'chao-nanguasi', name: '炒南瓜丝', emoji: '🎃', category: '素菜', isMeat: false, difficulty: 1, minutes: 15, servings: 2,
      tags: ['快手', '清淡'],
      ingredients: [
    ...
    {
      id: 'suchao-kongxincai', name: '素炒空心菜', emoji: '🥬', category: '素菜', isMeat: false, difficulty: 1, minutes: 10, servings: 2,
      tags: ['快手', '清淡'],
      ingredients: [
    ...
    // ============ 汤羹 ============
    {
      id: 'fqie-danhuatang', name: '番茄蛋花汤', emoji: '🍲', category: '汤羹', isMeat: false, difficulty: 1, minutes: 10, servings: 2,
      tags: ['快手', '汤'],
      ingredients: [
    ...
    {
      id: 'zicai-danhuatang', name: '紫菜蛋花汤', emoji: '🌊', category: '汤羹', isMeat: false, difficulty: 1, minutes: 8, servings: 2,
      tags: ['快手', '汤'],
      ingredients: [
    ...
    {
      id: 'donggua-wanzitang', name: '冬瓜丸子汤', emoji: '🍲', category: '汤羹', isMeat: true, difficulty: 2, minutes: 25, servings: 2,
      tags: ['汤', '清淡'],
      ingredients: [
    ...
    {
      id: 'yumi-paigutang', name: '玉米排骨汤', emoji: '🌽', category: '汤羹', isMeat: true, difficulty: 2, minutes: 60, servings: 3,
      tags: ['汤', '硬菜'],
      ingredients: [
    ...
    {
      id: 'suanla-tang', name: '酸辣汤', emoji: '🥣', category: '汤羹', isMeat: false, difficulty: 2, minutes: 20, servings: 2,
      tags: ['汤', '微辣'],
      ingredients: [
    ...
    {
      id: 'bocai-doufutang', name: '菠菜豆腐汤', emoji: '🥬', category: '汤羹', isMeat: false, difficulty: 1, minutes: 15, servings: 2,
      tags: ['汤', '清淡'],
      ingredients: [
    ...
    {
      id: 'jungu-jitang', name: '菌菇鸡汤', emoji: '🍄', category: '汤羹', isMeat: true, difficulty: 2, minutes: 50, servings: 3,
      tags: ['汤'],
      ingredients: [
    ...
    {
      id: 'suanluobo-laoyatang', name: '酸萝卜老鸭汤', emoji: '🦆', category: '汤羹', isMeat: true, difficulty: 2, minutes: 40, servings: 3,
      tags: ['汤', '微辣'],
      ingredients: [
    ...
    {
      id: 'luobo-paigutang', name: '萝卜排骨汤', emoji: '🥕', category: '汤羹', isMeat: true, difficulty: 2, minutes: 60, servings: 3,
      tags: ['汤'],
      ingredients: [
    ...
    {
      id: 'donggua-paigutang', name: '冬瓜排骨汤', emoji: '🍲', category: '汤羹', isMeat: true, difficulty: 2, minutes: 60, servings: 3,
      tags: ['汤'],
      ingredients: [
    ...
    {
      id: 'lianou-paigutang', name: '莲藕排骨汤', emoji: '🥣', category: '汤羹', isMeat: true, difficulty: 2, minutes: 70, servings: 3,
      tags: ['汤'],
      ingredients: [
    ...
    {
      id: 'fanqie-dunniunan', name: '番茄炖牛腩', emoji: '🍅', category: '汤羹', isMeat: true, difficulty: 2, minutes: 90, servings: 3,
      tags: ['汤', '硬菜'],
      ingredients: [
    ...
    {
      id: 'shanyao-dunjitang', name: '山药炖鸡汤', emoji: '🍗', category: '汤羹', isMeat: true, difficulty: 2, minutes: 80, servings: 3,
      tags: ['汤'],
      ingredients: [
    ...
    {
      id: 'baicai-doufutang', name: '白菜豆腐汤', emoji: '🥬', category: '汤羹', isMeat: false, difficulty: 1, minutes: 15, servings: 2,
      tags: ['汤', '清淡'],
      ingredients: [
    ...
    {
      id: 'sigua-dantang', name: '丝瓜蛋汤', emoji: '🥒', category: '汤羹', isMeat: false, difficulty: 1, minutes: 10, servings: 2,
      tags: ['汤', '快手', '清淡'],
      ingredients: [
    ...
    {
      id: 'yumi-shanyao-paigutang', name: '玉米山药排骨汤', emoji: '🌽', category: '汤羹', isMeat: true, difficulty: 2, minutes: 65, servings: 3,
      tags: ['汤'],
      ingredients: [
    ...
    {
      id: 'huanggua-dantang', name: '黄瓜蛋汤', emoji: '🥒', category: '汤羹', isMeat: false, difficulty: 1, minutes: 10, servings: 2,
      tags: ['汤', '快手', '清淡'],
      ingredients: [
    ...
    // ============ 主食 ============
    {
      id: 'danchaofan', name: '蛋炒饭', emoji: '🍚', category: '主食', isMeat: false, difficulty: 1, minutes: 15, servings: 2,
      tags: ['快手', '主食'],
      ingredients: [
    ...
    {
      id: 'fanqie-jidanmian', name: '番茄鸡蛋面', emoji: '🍜', category: '主食', isMeat: false, difficulty: 1, minutes: 15, servings: 2,
      tags: ['快手', '主食'],
      ingredients: [
    ...
    {
      id: 'congyou-banmian', name: '葱油拌面', emoji: '🍜', category: '主食', isMeat: false, difficulty: 1, minutes: 12, servings: 2,
      tags: ['快手', '主食'],
      ingredients: [
    ...
    {
      id: 'zhajiang-mian', name: '炸酱面', emoji: '🍜', category: '主食', isMeat: true, difficulty: 2, minutes: 30, servings: 2,
      tags: ['主食'],
      ingredients: [
    ...
    {
      id: 'jiangyou-chaofan', name: '酱油炒饭', emoji: '🍚', category: '主食', isMeat: false, difficulty: 1, minutes: 12, servings: 2,
      tags: ['快手', '主食'],
      ingredients: [
        { name: '米饭', amount: '2碗' }, { name: '鸡蛋', amount: '2个' },
    ...
    {
      id: 'gali-jiroufan', name: '咖喱鸡肉盖浇饭', emoji: '🍛', category: '主食', isMeat: true, difficulty: 1, minutes: 35, servings: 2,
      tags: ['快手', '主食'],
      ingredients: [
